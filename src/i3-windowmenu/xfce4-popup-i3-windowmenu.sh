...
export TEXTDOMAINDIR="@localedir@" # /usr/share/locale
...
case "$1" in
  -h|--help)
    ...
    ;;
  -V|--version)
    exec @bindir@/xfce4-panel -V "$(basename $0)" # /usr/bin/xfce4-panel
    exit 0
    ;;
  -p|--pointer)
    ATPOINTER="true"
...
exec @bindir@/xfce4-panel --plugin-event=i3-windowmenu:popup:bool:$ATPOINTER
